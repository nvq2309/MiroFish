    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single paragraph of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to a <span class="highlight-orange">million agents</span> based on the reality seeds within it. By injecting variables from a God's-eye view, it finds the <span class="highlight-code">"local optimal solution"</span> in dynamic environments through complex swarm interactions.
            </p>
            <p class="slogan-text">
              Let the future be rehearsed among Agents, let decisions win after a hundred battles<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Avg. $5/time for regular simulation</div>
            </div>
            <div class="metric-card">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction needs & dynamic update of temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with anyone in the simulated world & chat with the ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction needs in natural language (e.g., What public opinion trends will emerge if the university announces the revocation of the penalty?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
