...
// Get maxRounds from query params directly during initialization to ensure child components get it immediately
  ...
  try {
    ...
    if (simRes.success && simRes.data) {
      ...
      try {
        ...
        addLog(`Failed to get time config, using default: ${minutesPerRound.value} mins/round`)
      }
...
onMounted(() => {
  ...
  // Log maxRounds config (value already obtained from query params during init)
  if (maxRounds.value) {
